...
export function useHook() {
  const searchForm: GetProcureGetProcureMaterialPricePageApiParams = reactive(
    {}
  );
  ...
  async function onSearch() {
    loading.value = true;
    const { Code, Data } =
      await api.api.get_Procure_GetProcureMaterialPricePageApi({
